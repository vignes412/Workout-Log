...
import { initClient, fetchData, syncData } from "../utils/sheetsApi";
import {
  Typography,
  Button,
  Card,
...
const ExerciseList: React.FC<ExerciseListProps> = ({ 
  ...
  // Group exercises by muscle group for efficient rendering
  const filteredGroupedExercises = filteredExercises.reduce<Record<string, Exercise[]>>((acc, exercise) => {
    const key = exercise.muscleGroup || "Unknown";
    if (!acc[key]) {
      acc[key] = [];
    }
